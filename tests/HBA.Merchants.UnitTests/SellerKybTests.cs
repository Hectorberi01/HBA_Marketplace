...
public sealed class SellerKybTests
{
    ...
    /// <summary>AJOUTER UNE PIÈCE À UN DOSSIER DÉJÀ VÉRIFIÉ NE LE DÉ-VÉRIFIE PAS.</summary>
    [Fact]
    ...
    /// <summary>LE CŒUR DU CORRECTIF DÉCRIT DANS `RejectKyb` : LE REFUS SUSPEND.</summary>
    [Fact]
    ...
    /// <summary>ON NE TOUCHE PAS AUX COMPTES FERMÉS : ILS NE VENDENT DÉJÀ PLUS.</summary>
    [Fact]
    ...
    /// <summary>LE MOTIF DU REFUS PRÉCÉDENT NE SURVIT PAS AU NOUVEAU DÉPÔT.</summary>
    [Fact]
    ...
    /// <summary>
    /// RETIRER LA LIGNE SANS PRÉVENIR PERSONNE LAISSERAIT LA PIÈCE D'IDENTITÉ DANS
    /// LE BUCKET PRIVÉ, POUR TOUJOURS.
    /// </summary>
    [Fact]
    ...
    /// <summary>RETIRER SA DERNIÈRE PIÈCE RAMÈNE LE DOSSIER À « NON COMMENCÉ ».</summary>
    [Fact]
    ...
    /// <summary>ON NE DÉFAIT PAS LA DÉCISION D'UN ADMINISTRATEUR.</summary>
    [Fact]
    ...
    /// <summary>SOUMETTRE EST UN GESTE, PAS UN EFFET DE BORD.</summary>
    [Fact]
    ...
    /// <summary>
    /// Idempotent : l'app pourra appeler « soumettre » après chaque dépôt sans
    /// avoir à savoir si c'est la première pièce.
    /// </summary>
    [Fact]
    ...
    /// <summary>ON NE DÉ-VÉRIFIE PAS UN DOSSIER EN RÈGLE.</summary>
    [Fact]
    ...
    /// <summary>LA BASCULE AUTOMATIQUE VIT ENCORE, ET CE TEST LA GARDE VIVANTE.</summary>
    [Fact]
