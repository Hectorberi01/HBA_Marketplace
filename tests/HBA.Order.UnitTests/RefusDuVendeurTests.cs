...
/// <summary>UN VENDEUR REFUSE SA PART D'UNE COMMANDE DÉJÀ PAYÉE.</summary>
public sealed class RefusDuVendeurTests
{
    ...
    public void Un_refus_sans_motif_est_refuse(string motif)
    {
        ...
        // RIEN N'A BOUGÉ : ni l'état, ni l'événement.
    ...
    /// <summary>L'ÉVÉNEMENT DOIT PORTER DE QUOI AGIR, SANS RELIRE LA COMMANDE.</summary>
    [Fact]
    ...
    /// <summary>REFUSER ET SE DÉDIRE SONT DEUX GESTES, ET DEUX PERMISSIONS.</summary>
    [Fact]
    ...
    /// <summary>LA COMMANDE ENTIÈRE TOMBE : LA PART TOMBE, MAIS SANS ÉVÉNEMENT DE REFUS.</summary>
    [Fact]
    ...
    /// commande annulée » ferait perdre la CAUSE au profit de la conséquence — la
    /// même erreur que `ReviewReason` évite côté commande.
    /// </summary>
    [Fact]
