...
using HBA.Commerce.Infrastructure.Caching.Redis.Services;

namespace HBA.Commerce.Infrastructure.Caching.Redis;
...
{
    public static IServiceCollection AjouterCacheCommerce(
