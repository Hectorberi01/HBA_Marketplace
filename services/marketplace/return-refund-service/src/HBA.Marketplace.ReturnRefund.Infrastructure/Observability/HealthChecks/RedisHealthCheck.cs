...
namespace HBA.Marketplace.ReturnRefund.Infrastructure.Observability.HealthChecks;
...
/// celui qu'on croit. C'est le message de demarrage d'`AjouterCacheMarketplaceReturnRefund` qui
