using HBA.Marketplace.ReturnRefund.Infrastructure.Observability.HealthChecks;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;

using HBA.Shared.Application.Observability;
using HBA.Marketplace.ReturnRefund.Infrastructure.Observability.Metrics;
...
{
    public static IServiceCollection AjouterObservabiliteMarketplaceReturnRefund(
        this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddHealthChecks()
            .AddCheck<SondeDuCache>("cache-marketplace-return-refund", tags: ["ready"])
            .AddCheck<SondeDeKafka>("kafka-marketplace-return-refund", tags: ["ready"]);
        ...
        services.AddHealthChecks().AddCheck<SondeDesDestinationsGrpc>(
            "grpc-marketplace-return-refund", tags: ["dependencies"]);
