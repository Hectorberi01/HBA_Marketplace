...
namespace HBA.Marketplace.ReturnRefund.Infrastructure.Persistence.Inbox;
...
{
    private readonly ReturnRefundDbContext _context;

    public EfConsumerInbox(ReturnRefundDbContext context) => _context = context;
