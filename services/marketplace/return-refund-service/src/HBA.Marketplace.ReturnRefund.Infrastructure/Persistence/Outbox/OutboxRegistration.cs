...
namespace HBA.Marketplace.ReturnRefund.Infrastructure.Persistence.Outbox;
...
public static class OutboxRegistration
{
    ...
    public static IServiceCollection AjouterLOutboxLocale(this IServiceCollection services)
    {
        ...
        var moduleName = typeof(ReturnRefundDbContext).Name.Replace("DbContext", string.Empty);
        services.AddSingleton(new OutboxContextRegistration(typeof(ReturnRefundDbContext), moduleName));
