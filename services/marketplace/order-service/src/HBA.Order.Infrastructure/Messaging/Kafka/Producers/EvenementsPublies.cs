...
namespace HBA.Orders.Infrastructure.Messaging.Kafka.Producers;
...
public static class EvenementsPublies
{
    ...
    [
        ...
        typeof(OrderConfirmedIntegrationEvent),
        typeof(OrderDeliveredIntegrationEvent),
        typeof(OrderPlacedIntegrationEvent),
        typeof(OrderResumedAfterReviewIntegrationEvent),
        typeof(OrderUnderReviewIntegrationEvent),
        typeof(SellerOrderRefusedIntegrationEvent),
    ];
