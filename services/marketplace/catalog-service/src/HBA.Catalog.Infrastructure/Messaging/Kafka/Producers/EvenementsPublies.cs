...
namespace HBA.Catalog.Infrastructure.Messaging.Kafka.Producers;
...
public static class EvenementsPublies
{
    ...
    [
        typeof(BrandCreatedIntegrationEvent),
        typeof(BrandRequestApprovedIntegrationEvent),
        typeof(BrandRequestedIntegrationEvent),
        typeof(CategoryCreatedIntegrationEvent),
        typeof(ProductApprovedIntegrationEvent),
        typeof(ProductArchivedIntegrationEvent),
        typeof(ProductDeletedIntegrationEvent),
        typeof(ProductMediaRemovedIntegrationEvent),
        typeof(ProductPublishedIntegrationEvent),
        typeof(ProductRejectedIntegrationEvent),
        typeof(ProductRestoredIntegrationEvent),
        typeof(ProductSubmittedIntegrationEvent),
        typeof(ProductSuspendedIntegrationEvent),
        typeof(ProductUnpublishedIntegrationEvent),
    ];
