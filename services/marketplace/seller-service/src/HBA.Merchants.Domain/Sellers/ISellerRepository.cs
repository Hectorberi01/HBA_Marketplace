...
public interface ISellerRepository
{
    ...
    /// <summary>LA FILE D'ADMINISTRATION : UNE PAGE, DES FILTRES, ET LES COMPTEURS.</summary>
    /// <param name="search">Sous-chaîne du nom de boutique, insensible à la casse.</param>
    /// <param name="kybStatus">Filtre sur l'état du dossier.</param>
    /// <param name="status">Filtre sur l'état commercial.</param>
    /// <returns>
    /// La page, le total APRÈS filtres, et le comptage par `KybStatus` — ce dernier
    /// calculé sur la recherche SANS le filtre de statut, sans quoi la facette
    /// sélectionnée serait la seule non nulle et les autres afficheraient zéro
    /// alors qu'il y a du travail.
    /// </returns>
