...
public static class OutboxRegistration
{
    ...
    public static IServiceCollection AjouterLOutboxLocale(this IServiceCollection services)
    {
        ...
        // mortes.
        var moduleName = typeof(SellersDbContext).Name.Replace("DbContext", string.Empty);
        services.AddSingleton(new OutboxContextRegistration(typeof(SellersDbContext), moduleName));
