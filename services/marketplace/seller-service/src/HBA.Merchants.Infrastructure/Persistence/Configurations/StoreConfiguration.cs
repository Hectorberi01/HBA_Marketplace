...
internal sealed class StoreConfiguration : IEntityTypeConfiguration<Store>
{
    public void Configure(EntityTypeBuilder<Store> builder)
    {
        ...
        // Simple Guid : Sellers ne référence pas Inventory.
        ...
        // IGNORÉES, PAS MAPPÉES. `OpeningHours` et `IsSelling` sont des propriétés
        // CALCULÉES — une vue en lecture seule et un booléen dérivé du statut.
