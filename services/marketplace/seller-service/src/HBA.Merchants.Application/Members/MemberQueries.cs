...
/// <summary>Le catalogue des permissions.</summary>
    ...
    IQueryHandler<ListPermissionsQuery, IReadOnlyList<PermissionView>>
{
    ...
    /// <summary>UN RÔLE ABSENT DU CATALOGUE EST NOMMÉ, PAS OMIS.</summary>
    ...
    /// <summary>
    /// Le domaine d'une permission, déduit de son code — <c> ORDER_CONFIRM</c> →
    /// <c> ORDER</c>.
    /// </summary>
