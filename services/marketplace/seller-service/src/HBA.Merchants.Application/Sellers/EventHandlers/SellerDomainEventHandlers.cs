...
/// <summary>
/// Publie l'event d'intégration « vendeur fermé » (Catalog retire les produits de
/// la vente).
/// </summary>
...
/// <summary>
/// Publie l'event d'intégration « dossier KYB refusé » (Notifications prévient le
/// vendeur).
/// </summary>
...
/// <summary>
/// Publie l'event d'intégration « vendeur suspendu » (Products retire le
/// catalogue).
/// </summary>
...
/// <summary>
/// Publie l'event d'intégration « vendeur supprimé » (Catalog purge les produits).
/// </summary>
...
/// <summary>Publie « pièce KYB retirée », pour que le fichier soit réellement effacé.</summary>
...
/// <summary>Publie « dossier KYB soumis » (§10.3 : `merchant.kyc.submitted`).</summary>
...
/// <summary>Publie « dossier KYB validé » (§10.3 : `merchant.kyc.approved`).</summary>
