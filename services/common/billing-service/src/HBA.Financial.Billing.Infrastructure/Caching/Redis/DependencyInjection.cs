...
using HBA.Financial.Billing.Infrastructure.Caching.Redis.Services;

namespace HBA.Financial.Billing.Infrastructure.Caching.Redis;
...
{
    public static IServiceCollection AjouterCacheFinancialBilling(
