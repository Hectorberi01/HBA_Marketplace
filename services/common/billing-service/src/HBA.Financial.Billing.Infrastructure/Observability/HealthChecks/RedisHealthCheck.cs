...
namespace HBA.Financial.Billing.Infrastructure.Observability.HealthChecks;
...
/// celui qu'on croit. C'est le message de demarrage d'`AjouterCacheFinancialBilling` qui
