...
namespace HBA.Engagement.Recommendations.Infrastructure.Persistence.Outbox;
...
public static class OutboxRegistration
{
    ...
    public static IServiceCollection AjouterLOutboxLocale(this IServiceCollection services)
    {
        ...
        var moduleName = typeof(RecommendationsDbContext).Name.Replace("DbContext", string.Empty);
        services.AddSingleton(new OutboxContextRegistration(typeof(RecommendationsDbContext), moduleName));
        ...
        // PAS DE PURGE D'INBOX : ce service ne consomme rien, il n'a donc pas de
