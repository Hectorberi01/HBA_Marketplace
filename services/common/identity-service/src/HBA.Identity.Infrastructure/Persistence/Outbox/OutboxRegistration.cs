...
public static class OutboxRegistration
{
    ...
    public static IServiceCollection AjouterLOutboxLocale(this IServiceCollection services)
    {
        ...
        // mortes.
        var moduleName = typeof(IdentityDbContext).Name.Replace("DbContext", string.Empty);
        services.AddSingleton(new OutboxContextRegistration(typeof(IdentityDbContext), moduleName));
