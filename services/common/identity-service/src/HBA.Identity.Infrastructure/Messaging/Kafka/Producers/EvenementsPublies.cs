...
namespace HBA.Identity.Infrastructure.Messaging.Kafka.Producers;
...
public static class EvenementsPublies
{
    ...
    [
        typeof(EmailVerificationRequestedIntegrationEvent),
        typeof(OtpChallengeIssuedIntegrationEvent),
        typeof(PasswordResetRequestedIntegrationEvent),
        typeof(TokenRevokedIntegrationEvent),
        typeof(UserAnonymizedIntegrationEvent),
        typeof(UserEmailConfirmedIntegrationEvent),
