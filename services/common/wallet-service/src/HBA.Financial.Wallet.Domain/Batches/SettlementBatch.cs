...
public enum SettlementStatus
{
    ...
    /// pourront être inclus dans un prochain lot.
    /// </summary>
    Cancelled = 4
}
...
/// <summary>Reversement à un vendeur : net après commission.</summary>
...
/// <summary>Lot de reversements agrégés par période.</summary>
public sealed class SettlementBatch : AggregateRoot<SettlementBatchId>
{
    ...
    /// <summary>MARQUE UN VERSEMENT COMME REFUSÉ PAR L'OPÉRATEUR.</summary>
    ...
    /// <summary>Annule un lot AVANT tout versement.</summary>
