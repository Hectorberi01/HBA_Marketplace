...
namespace HBA.Financial.Wallet.Infrastructure.Observability.HealthChecks;
...
/// celui qu'on croit. C'est le message de demarrage d'`AjouterCacheFinancialWallet` qui
