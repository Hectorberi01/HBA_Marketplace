...
using HBA.Communication.Infrastructure.Caching.Redis.Services;

namespace HBA.Communication.Infrastructure.Caching.Redis;
...
{
    public static IServiceCollection AjouterCacheCommunication(
