using HBA.Communication.Infrastructure.Observability.HealthChecks;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;

using HBA.Shared.Application.Observability;
using HBA.Communication.Infrastructure.Observability.Metrics;
using Microsoft.Extensions.DependencyInjection.Extensions;
namespace HBA.Communication.Infrastructure.Observability;
...
{
    public static IServiceCollection AjouterObservabiliteCommunication(
        this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddHealthChecks()
            .AddCheck<SondeDuCache>("cache-communication", tags: ["ready"])
            .AddCheck<SondeDeKafka>("kafka-communication", tags: ["ready"]);
        ...
        services.AddHealthChecks().AddCheck<SondeDesDestinationsGrpc>(
            "grpc-communication", tags: ["dependencies"]);
