...
using HBA.Communication.Notifications.Infrastructure.Caching.Redis.Services;

namespace HBA.Communication.Notifications.Infrastructure.Caching.Redis;
...
{
    public static IServiceCollection AjouterCacheCommunicationNotifications(
