...
namespace HBA.Communication.Notifications.Infrastructure.Observability.HealthChecks;
...
/// celui qu'on croit. C'est le message de demarrage d'`AjouterCacheCommunicationNotifications` qui
