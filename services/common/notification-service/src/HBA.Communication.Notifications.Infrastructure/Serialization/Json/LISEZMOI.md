...
Vide dans **HBA.Communication.Notifications.Infrastructure**.

**Ce qui va ici :** les options JSON propres a ce service.

**Ou ca vit aujourd'hui :** `HBA.Shared.Infrastructure.Serialization` — le format de l'enveloppe en depend
