...
namespace HBA.Promotions.Infrastructure.Messaging.Kafka.Producers;
...
public static class EvenementsPublies
{
    ...
    [
        typeof(CouponUsedIntegrationEvent),
        typeof(PromotionCreatedIntegrationEvent),
        typeof(PromotionExhaustedIntegrationEvent),
    ];
