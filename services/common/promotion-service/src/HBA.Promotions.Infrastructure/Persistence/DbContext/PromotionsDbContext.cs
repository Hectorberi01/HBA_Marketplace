...
/// <summary>LE MODULE PROMOTION — SA PROPRE BASE (§9, §10.16 : <c>promotion_db</c>).</summary>
public sealed class PromotionsDbContext : ModuleDbContext, IOutboxDbContext, IPromotionsUnitOfWork
{
