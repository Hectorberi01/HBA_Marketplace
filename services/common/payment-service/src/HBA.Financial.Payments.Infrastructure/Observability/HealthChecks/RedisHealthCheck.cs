...
namespace HBA.Financial.Payments.Infrastructure.Observability.HealthChecks;
...
/// celui qu'on croit. C'est le message de demarrage d'`AjouterCacheFinancialPayments` qui
