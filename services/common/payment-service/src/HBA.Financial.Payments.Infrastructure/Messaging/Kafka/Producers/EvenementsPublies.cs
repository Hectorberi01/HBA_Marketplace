...
namespace HBA.Financial.Payments.Infrastructure.Messaging.Kafka.Producers;
...
public static class EvenementsPublies
{
    ...
    [
        ...
        typeof(PaymentCreatedIntegrationEvent),
        typeof(PaymentFailedIntegrationEvent),
        typeof(PaymentRefundFailedIntegrationEvent),
        typeof(PaymentRefundedIntegrationEvent),
    ];
