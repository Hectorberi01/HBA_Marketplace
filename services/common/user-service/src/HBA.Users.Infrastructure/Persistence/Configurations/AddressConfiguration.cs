...
internal sealed class AddressConfiguration : IEntityTypeConfiguration<Address>
{
    public void Configure(EntityTypeBuilder<Address> builder)
    {
        ...
        // table échapperait à HasDefaultSchema et le module écrirait hors de chez
        // lui.
        ...
        // COMMUNE, QUARTIER, REPÈRE ET RUE SONT NULLABLES EN BASE, ET OBLIGATOIRES
        // DANS LE DOMAINE (sauf quartier et rue).
        ...
        // Position facultative : `double precision`, nullable.
        builder.Property(a => a.Latitude);
        builder.Property(a => a.Longitude);
        builder.Property(a => a.IsDefault).IsRequired();
        builder.Property(a => a.CreatedOnUtc).IsRequired();

        // Propriétés calculées : elles se résolvent depuis BeninGeography, rien à
        // stocker.
        ...
        // Sert au futur calcul de frais par zone, et déjà aux statistiques : «
        // combien de livraisons hors du Grand Nokoué ? » ne doit pas balayer toute
        // la table.
