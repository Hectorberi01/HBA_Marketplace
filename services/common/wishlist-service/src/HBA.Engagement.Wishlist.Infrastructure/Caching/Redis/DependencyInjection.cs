...
using HBA.Engagement.Wishlist.Infrastructure.Caching.Redis.Services;

namespace HBA.Engagement.Wishlist.Infrastructure.Caching.Redis;
...
{
    public static IServiceCollection AjouterCacheEngagementWishlist(
