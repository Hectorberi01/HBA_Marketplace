...
public sealed class WishlistDbContextFactory : IDesignTimeDbContextFactory<WishlistDbContext>
{
    ...
    {
        var connectionString = Environment.GetEnvironmentVariable("WISHLIST_DB")
        ...
        return new WishlistDbContext(options, NoOpDomainEventDispatcher.Instance, new IntegrationEventQueue());
    }
