...
namespace HBA.Engagement.Reviews.Infrastructure.Messaging.Kafka.Producers;
...
public static class EvenementsPublies
{
    ...
    [
        typeof(ReviewPublishedIntegrationEvent),
        typeof(ReviewRejectedIntegrationEvent),
        typeof(SellerRatingRecomputedIntegrationEvent),
    ];
