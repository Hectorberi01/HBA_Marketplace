...
namespace HBA.Engagement.Reviews.Infrastructure.Messaging.Kafka;
...
/// `Inbox/` est absent : ce service ne consomme aucun evenement.
...
public static class DependencyInjection
{
    ...
    /// </summary>
    public static IServiceCollection AjouterMessagerieEngagementReviews(this IServiceCollection services)
    {
        ...
        services.AjouterSujetsEngagementReviews();
        services.AjouterOutboxEngagementReviews();
