...
using HBA.Media.Infrastructure.Caching.Redis.Services;

namespace HBA.Media.Infrastructure.Caching.Redis;
...
{
    public static IServiceCollection AjouterCacheMedia(
