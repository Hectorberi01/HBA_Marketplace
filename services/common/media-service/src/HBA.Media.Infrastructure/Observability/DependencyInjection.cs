using HBA.Media.Infrastructure.Observability.HealthChecks;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;

using HBA.Shared.Application.Observability;
using HBA.Media.Infrastructure.Observability.Metrics;
using Microsoft.Extensions.DependencyInjection.Extensions;
namespace HBA.Media.Infrastructure.Observability;
...
{
    public static IServiceCollection AjouterObservabiliteMedia(
        this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddHealthChecks()
            .AddCheck<SondeDuCache>("cache-media", tags: ["ready"])
            .AddCheck<SondeDeKafka>("kafka-media", tags: ["ready"]);
