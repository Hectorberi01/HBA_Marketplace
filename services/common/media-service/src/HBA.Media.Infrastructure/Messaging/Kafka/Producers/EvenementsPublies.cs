...
namespace HBA.Media.Infrastructure.Messaging.Kafka.Producers;
...
public static class EvenementsPublies
{
    ...
    [
        typeof(MediaDeletedIntegrationEvent),
        typeof(MediaProcessingFailedIntegrationEvent),
        typeof(MediaReadyIntegrationEvent),
    ];
