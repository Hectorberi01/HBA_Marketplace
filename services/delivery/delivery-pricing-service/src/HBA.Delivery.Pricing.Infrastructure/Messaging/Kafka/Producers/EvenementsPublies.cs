...
namespace HBA.Delivery.Pricing.Infrastructure.Messaging.Kafka.Producers;
...
public static class EvenementsPublies
{
    ...
    [
        typeof(DeliveryPricingRuleCreatedIntegrationEvent),
        typeof(DeliveryPricingRuleUpdatedIntegrationEvent),
        typeof(DeliveryQuoteConsumedIntegrationEvent),
        typeof(DeliveryQuoteCreatedIntegrationEvent),
    ];
