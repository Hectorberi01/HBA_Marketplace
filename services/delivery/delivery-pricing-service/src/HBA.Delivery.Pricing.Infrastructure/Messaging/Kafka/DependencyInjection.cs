...
namespace HBA.Delivery.Pricing.Infrastructure.Messaging.Kafka;
...
public static class DependencyInjection
{
    ...
    /// </summary>
    public static IServiceCollection AjouterMessagerieDeliveryPricing(this IServiceCollection services)
    {
        ...
        services.AjouterSujetsDeliveryPricing();
        services.AjouterOutboxDeliveryPricing();
