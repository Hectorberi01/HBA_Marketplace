...
namespace HBA.Delivery.Pricing.Infrastructure.Persistence.Inbox;
...
{
    private readonly DeliveryPricingDbContext _context;

    public EfConsumerInbox(DeliveryPricingDbContext context) => _context = context;
