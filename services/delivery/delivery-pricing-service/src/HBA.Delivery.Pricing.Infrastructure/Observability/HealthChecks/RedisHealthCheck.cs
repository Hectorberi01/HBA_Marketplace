...
namespace HBA.Delivery.Pricing.Infrastructure.Observability.HealthChecks;
...
/// celui qu'on croit. C'est le message de demarrage d'`AjouterCacheDeliveryPricing` qui
