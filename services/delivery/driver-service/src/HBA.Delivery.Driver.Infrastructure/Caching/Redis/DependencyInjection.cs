...
using HBA.Drivers.Infrastructure.Caching.Redis.Services;

namespace HBA.Drivers.Infrastructure.Caching.Redis;
...
{
    public static IServiceCollection AjouterCacheDeliveryDriver(
