...
namespace HBA.Delivery.Driver.Infrastructure.Messaging.Kafka.Producers;
...
public static class EvenementsPublies
{
    ...
    [
        typeof(DriverCreatedIntegrationEvent),
        typeof(DriverDossierVerifiedIntegrationEvent),
        typeof(DriverSuspendedIntegrationEvent),
        typeof(DriverVehicleUpdatedIntegrationEvent),
