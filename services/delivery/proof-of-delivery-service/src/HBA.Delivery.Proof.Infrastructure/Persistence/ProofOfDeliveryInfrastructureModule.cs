...
namespace HBA.ProofOfDelivery.Infrastructure;

public static class ProofOfDeliveryInfrastructureModule
{
    public static IServiceCollection AddProofOfDeliveryInfrastructure(this IServiceCollection services)
    {
        services.AddSingleton<ProofStore>();
        // ═════════════════════════════════════════════════════════════════
        ...
        // jamais parti, même une seule fois. La preuve de remise ne clôture
        // jamais la course : la livraison reste ouverte et le paiement du
        // livreur n'est jamais déclenché.
        //
        ...
        // IOutboxDbContext`. proof-of-delivery-service n'a ni `DbContext`, ni table
        // `outbox_messages`, ni migration, ni chaîne de connexion : son état
        // tient dans un `ConcurrentDictionary` (ProofStore). Il n'y a rien à quoi
        ...
        //
        //     services.AddOutboxProcessor<ProofDbContext>();
        //
