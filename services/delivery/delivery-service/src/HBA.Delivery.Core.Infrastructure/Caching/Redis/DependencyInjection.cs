...
using HBA.Deliveries.Infrastructure.Caching.Redis.Services;

namespace HBA.Deliveries.Infrastructure.Caching.Redis;
...
{
    public static IServiceCollection AjouterCacheDeliveryCore(
