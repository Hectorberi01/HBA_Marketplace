...
public static class EvenementsPublies
{
    ...
    [
        typeof(DriverVerifiedIntegrationEvent),
    ];
    ...
    [
        typeof(DeliveryAcceptedIntegrationEvent),
        typeof(DeliveryAssignedIntegrationEvent),
        typeof(DeliveryCancelledIntegrationEvent),
        typeof(DeliveryCompletedIntegrationEvent),
        typeof(DeliveryCreatedIntegrationEvent),
        typeof(DeliveryNoDriverAvailableIntegrationEvent),
        typeof(DeliveryPickedUpIntegrationEvent),
    ];
