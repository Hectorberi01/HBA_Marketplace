...
namespace HBA.Delivery.Core.Infrastructure.Persistence.Migrations
{
    [DbContext(typeof(DeliveriesDbContext))]
    [Migration("20260906202955_ZZVerificationRealignement")]
            ...
            modelBuilder.Entity("HBA.Deliveries.Domain.Deliveries.Delivery", b =>
                {
                    ...
                    b.ToTable("deliveries", "deliveries", t =>
                        {
                            t.HasCheckConstraint("ck_deliveries_earning_has_basis", "\"DriverEarning\" IS NULL OR (\"Price\" IS NOT NULL AND \"DriverShareRate\" IS NOT NULL)");

                            t.HasCheckConstraint("ck_deliveries_price_has_currency", "\"Price\" IS NULL OR \"Currency\" IS NOT NULL");
                        });
                });
