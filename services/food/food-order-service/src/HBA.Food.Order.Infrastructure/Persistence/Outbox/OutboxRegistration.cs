...
namespace HBA.FoodOrders.Infrastructure.Persistence.Outbox;
...
public static class OutboxRegistration
{
    ...
    public static IServiceCollection AjouterLOutboxLocale(this IServiceCollection services)
    {
        ...
        // mortes.
        var moduleName = typeof(MealOrderingDbContext).Name.Replace("DbContext", string.Empty);
        services.AddSingleton(new OutboxContextRegistration(typeof(MealOrderingDbContext), moduleName));
