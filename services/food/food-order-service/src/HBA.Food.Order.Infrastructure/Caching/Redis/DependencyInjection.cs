...
using HBA.FoodOrders.Infrastructure.Caching.Redis.Services;

namespace HBA.FoodOrders.Infrastructure.Caching.Redis;
...
{
    public static IServiceCollection AjouterCacheFoodOrder(
