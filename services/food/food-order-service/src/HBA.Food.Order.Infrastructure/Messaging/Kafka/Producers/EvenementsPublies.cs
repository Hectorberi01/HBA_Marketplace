...
namespace HBA.Food.Order.Infrastructure.Messaging.Kafka.Producers;
...
public static class EvenementsPublies
{
    ...
    [
        typeof(MealOrderCancelledIntegrationEvent),
        typeof(MealOrderConfirmedIntegrationEvent),
        typeof(MealOrderDeliveredIntegrationEvent),
        typeof(MealOrderPlacedIntegrationEvent),
        typeof(MealOrderResumedAfterReviewIntegrationEvent),
        typeof(MealOrderUnderReviewIntegrationEvent),
    ];
