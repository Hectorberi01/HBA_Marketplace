...
namespace HBA.Food.Order.Infrastructure.Messaging.Kafka.Configuration;
...
/// `AjouterMessagerieFoodOrder()`, qu'il peut oublier. Un oubli ne casse RIEN de
    ...
    public Task StartAsync(CancellationToken cancellationToken)
    {
        if (services.GetService<AbonnementsKafka>() is null)
        {
            throw new InvalidOperationException(
                ...
                + "« builder.Services.AjouterMessagerieFoodOrder(); » dans Program.cs.");
        }
