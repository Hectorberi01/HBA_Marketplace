...
namespace HBA.Food.Restaurant.Infrastructure.Messaging.Kafka.Producers;
...
public static class EvenementsPublies
{
    ...
    [
        typeof(FoodOrderAcceptedIntegrationEvent),
        typeof(FoodOrderCancelledIntegrationEvent),
        typeof(FoodOrderDeliveredIntegrationEvent),
        typeof(FoodOrderPickedUpIntegrationEvent),
        typeof(FoodOrderPreparingIntegrationEvent),
        typeof(FoodOrderReadyForPickupIntegrationEvent),
        typeof(FoodOrderReceivedIntegrationEvent),
        typeof(FoodOrderRejectedIntegrationEvent),
        typeof(RestaurantApprovedIntegrationEvent),
        typeof(RestaurantRejectedIntegrationEvent),
        typeof(RestaurantReopenedIntegrationEvent),
        typeof(RestaurantSuspendedIntegrationEvent),
    ];
