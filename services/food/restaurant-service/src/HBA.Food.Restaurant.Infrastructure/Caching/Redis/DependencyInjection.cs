...
using HBA.Food.Infrastructure.Caching.Redis.Services;

namespace HBA.Food.Infrastructure.Caching.Redis;
...
{
    public static IServiceCollection AjouterCacheFoodRestaurant(
