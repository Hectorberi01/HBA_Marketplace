...
namespace HBA.FoodCarts.Infrastructure.Persistence.Inbox;
...
{
    private readonly FoodCartDbContext _context;

    public EfConsumerInbox(FoodCartDbContext context) => _context = context;
