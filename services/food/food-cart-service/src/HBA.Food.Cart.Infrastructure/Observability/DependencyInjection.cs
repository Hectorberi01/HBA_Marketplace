using HBA.FoodCarts.Infrastructure.Observability.HealthChecks;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;

using HBA.Shared.Application.Observability;
using HBA.FoodCarts.Infrastructure.Observability.Metrics;
using Microsoft.Extensions.DependencyInjection.Extensions;
namespace HBA.FoodCarts.Infrastructure.Observability;
...
{
    public static IServiceCollection AjouterObservabiliteFoodCart(
        this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddHealthChecks()
            .AddCheck<SondeDuCache>("cache-food-cart", tags: ["ready"])
            .AddCheck<SondeDeKafka>("kafka-food-cart", tags: ["ready"]);
        ...
        services.AddHealthChecks().AddCheck<SondeDesDestinationsGrpc>(
            "grpc-food-cart", tags: ["dependencies"]);
