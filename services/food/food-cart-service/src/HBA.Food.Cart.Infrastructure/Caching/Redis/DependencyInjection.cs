...
using HBA.FoodCarts.Infrastructure.Caching.Redis.Services;

namespace HBA.FoodCarts.Infrastructure.Caching.Redis;

/// <summary>LE CACHE DE CE SERVICE — UN SEUL POINT D'ENTREE.</summary>
public static class DependencyInjection
{
    public static IServiceCollection AjouterCacheFoodCart(
