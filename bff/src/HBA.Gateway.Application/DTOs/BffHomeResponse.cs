...
/// <summary>Réponse d'un écran d'accueil agrégé.</summary>
/// <param name="Surface">
/// « express » ou « food ». Présent DÉLIBÉRÉMENT dans le corps : les deux univers
/// ne doivent jamais être confondus côté client, et une réponse qui s'identifie
/// elle-même rend l'erreur visible immédiatement plutôt qu'au moment où un produit
/// s'affiche dans un menu de restaurant.
/// </param>
