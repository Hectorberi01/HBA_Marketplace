using HBA.Gateway.Infrastructure.Observability.HealthChecks;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;

using HBA.Shared.Application.Observability;
using HBA.Gateway.Infrastructure.Observability.Metrics;
using Microsoft.Extensions.DependencyInjection.Extensions;
namespace HBA.Gateway.Infrastructure.Observability;
...
{
    public static IServiceCollection AjouterObservabiliteGateway(
        this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddHealthChecks()
            .AddCheck<SondeDuCache>("cache-gateway", tags: ["ready"])
            .AddCheck<SondeDeKafka>("kafka-gateway", tags: ["ready"]);
        ...
        services.AddHealthChecks().AddCheck<SondeDesDestinationsGrpc>(
            "grpc-gateway", tags: ["dependencies"]);
